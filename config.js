...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '923192106398'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? 'Maaz' : process.env.OWNER_NAME,  
